...
void* serializar_paquete(t_paquete* paquete, int *bytes){
	...
	bytes_escritos += paquete->buffer->size; // Por si en un futuro...


	bytes = size_serializado; //Modifico el contenido del puntero
	return buffer;
...
char* recibir_mensaje(int socket_cliente){
	...
	// Podria agregar un control sobre el buffer
	return buffer;
}
